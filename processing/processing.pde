...
void draw() {
  ...
  if(input != null){
    ...
    print(dataSensors[0],'\n',dataSensors[1],'\n',dataSensors[2],'\n');    
    loadStrings("https://www.marcodifrancesco.com/tesina/insertData.php?data1="+dataSensors[0]+"&data2="+dataSensors[1]+"&data3="+dataSensors[2]+"&data4="+dataSensors[3]+"&data5="+dataSensors[4]+"&data6="+dataSensors[5]);
//    loadStrings("http://127.0.0.1/website/tesina/insertData.php?data1="+dataSensors[0]+"&data2="+dataSensors[1]+"&data3="+dataSensors[2]+"&data4="+dataSensors[3]+"&data5="+dataSensors[4]+"&data6="+dataSensors[5]);
  }
